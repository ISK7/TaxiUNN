...
import com.example.driverapp.regPart.AuthorizationActivity;
import com.example.driverapp.regPart.MainAppActivity;
import com.example.driverapp.requests.refresh;
        ...
        call.enqueue(new Callback<Ans_refresh>() {
            ...
            public void onResponse(Call<Ans_refresh> call, Response<Ans_refresh> response) {
                if (response.isSuccessful()) {
                    ...
                    // Обрабатываем ошибку
                    Log.d("Failed", "Message: " + "Refresh field is required.");
                    //Доделать!
                }
            }
